...
const open = (config, logger) => new Database(config, logger);
...
pg.select('application')
  .where({ tableowner: 'admin', schemaname: 'users' })
  ...
  // Here would be MODE_ROWS

  // Task: set callbacks for resolving in config